...
const initialLetters = [
  ...
  },
  {
    ...
    title: '키움 우승',
    from: '홍원기',
    image: 'https://yt3.googleusercontent.com/HmU-cGuNTGaoyJ2dSCW7CrdNMLVXq8xgKQ2Tsri543dTS7RMSgcseDb8p9w-g2amOoNJkXxT=s900-c-k-c0x00ffffff-no-rj',
  },
  {
    id: 3,
    title: '레터2',
        ...
        {letters.map((letter) => (
          <div key={letter.id} className="relative flex items-center my-8">
            <div
              ...
              onClick={() => handleSlide(letter.id)}
            >
              <img src={letter.image} alt="Letter" className="w-16 h-24 mr-4 rounded-lg" />
            ...
            {slideId === letter.id && (
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 7l-1 12H6L5 7m5 4v6m4-6v6m1-14H9m1-4h4m-4 4h4m2 2v2m0 4H7m1-14h4m-4 4h4" />
                </svg>
              </div>
            )}
          </div>
